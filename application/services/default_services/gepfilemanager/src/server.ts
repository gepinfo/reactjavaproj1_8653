...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_reactjavaproj1_8653;
            let db_auth = result.data.DB_AUTH_reactjavaproj1_8653;
            let db_coll = result.data.DB_COLL_reactjavaproj1_8653;
